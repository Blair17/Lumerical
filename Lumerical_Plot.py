...
datafilename = '/Volumes/Sam/Lumerical/Optimising_GMRM/Pedestal_Investigation/Index_Shifts/10nm_Layer/variation/n_R_2.00.txt'
datafilepath = os.path.join(
    root,
    datafilename)
...
datafilename = '/Volumes/Sam/Lumerical/Optimising_GMRM/Pedestal_Investigation/Index_Shifts/10nm_Layer/variation/n_R_2.05.txt'
datafilepath = os.path.join(
    root,
    datafilename)
...
# axs.plot(lamR3, refl3, lw=3, color='darkviolet', label='n = 2.10')
# axs.plot(lamR2, refl2, lw=3, color='crimson', label='No Charge Layer Refl')
