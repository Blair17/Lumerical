...
files_refl = glob.glob('/Volumes/Sam/Lumerical/Final_modulator/modulation_data/091024/data/refl/*.txt')
sorted_refl = sorted(files_refl, key = last_9chars)  

files_phase = glob.glob('/Volumes/Sam/Lumerical/Final_modulator/modulation_data/091024/data/phase/*.txt')
...
datafilename = '/Volumes/Sam/Lumerical/Final_modulator/modulation_data/091024/data//wav/wavelength.txt'
datafilepath = os.path.join(
        root,
        datafilename)
wav = np.genfromtxt(
...
nacc_array = [1.00, 1.375, 1.750, 2.125, 2.500, 2.875, 3.250, 3.625, 4.000]
...
fig.tight_layout()
fig.savefig('plot/101024/Refl_highres.png', dpi=300)
...
fig1.tight_layout()
fig1.savefig('plot/101024/Phase_highres.png', dpi=300)
...
fig2.tight_layout()
plt.grid(True)
fig2.savefig('plot/101024/Phase_plot.png')
