...
files_refl = glob.glob('/Volumes/Sam/Lumerical/Plasmonics/Gold_nanoballs/radius_variation/data/refl/*.txt')
sorted_refl = sorted(files_refl, key = last_9chars)  

files_phase = glob.glob('/Volumes/Sam/Lumerical/Plasmonics/Gold_nanoballs/radius_variation/data/phase/*.txt')
...
datafilename = '/Volumes/Sam/Lumerical/Plasmonics/Gold_nanoballs/radius_variation/data/wav/wavelength.txt'
datafilepath = os.path.join(
        root,
        datafilename)
wav = np.genfromtxt(
...
opt_buffer_values = np.linspace(20,150,11)
